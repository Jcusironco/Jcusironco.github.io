...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($nick) || empty($pass1) || empty($nivel) || empty($nombre) || empty($telefono)) {
  ...
  $pass1 = sha1($pass1);
  $ins = $con->query("INSERT INTO usuario VALUES('', '$nick', '$pass1', '$nombre', '$correo','$telefono', '$nivel', 1, '$ruta')");
